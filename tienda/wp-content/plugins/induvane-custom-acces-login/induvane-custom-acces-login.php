...
/*
Plugin Name: InduVane custom access login
Description: Este plugin restringe el acceso a la tienda a usuarios no autenticados.
Version: 1.0
Author: Damian Rojas
*/
...
function induvane_custom_access_login() {
    global $post;
...
add_action('template_redirect', 'induvane_custom_access_login');
